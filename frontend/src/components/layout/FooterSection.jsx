            ...
            <div>
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">+91 8290052977</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-blue-500/20 rounded-lg flex items-center justify-center">
                    <FaEnvelope className="w-4 h-4 text-blue-400" />
                  </div>
                  <span className="text-gray-300">info@incentum.ai</span>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 bg-blue-500/20 rounded-lg flex items-center justify-center mt-1">
                    <FaMapMarkerAlt className="w-4 h-4 text-blue-400" />
                  </div>
                  <span className="text-gray-300">PC Soft Building, 3rd Floor, Bhandarkar Road, Pune - 411004</span>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <span className="text-sm text-gray-300">Registered Brand</span>
              </div>
              <div className="flex flex-col items-center space-y-2">
