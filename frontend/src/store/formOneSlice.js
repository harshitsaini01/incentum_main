...
export const savePersonalDetails = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post('/form/personal-details', data);
...
export const saveLoanApplication = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post('/form/loan-application', data, {
...
export const uploadLoanDocuments = createAsyncThunk(
  ...
  async (formData, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post('/form/loan-documents', formData, {
...
export const fetchFormById = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      console.log(`Fetching form from /form/${id}`);
...
export const fetchFormsByUserId = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      console.log(`Fetching forms for user ID from /form/user/${userId}`);
      const response = await axios.get(`/form/user/${userId}`, {
        withCredentials: true,
      });
...
export const updateForm = createAsyncThunk(
  ...
  async ({ id, data }, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.put(`/form/${id}`, data);
...
export const deleteForm = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      console.log(`Sending DELETE request to /form/${id}`);
