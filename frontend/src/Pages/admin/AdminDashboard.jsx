...
import { FiEye, FiSearch, FiRefreshCw, FiHome, FiFileText, FiSettings, FiLogOut, FiUser, FiUsers, FiDollarSign, FiDownload, FiTrash2, FiShield, FiDatabase, FiMail } from 'react-icons/fi';
...
const AdminDashboard = () => {
  ...
  const fetchApplications = async () => {
    try {
      ...
      const firstResponse = await axios.get('/api/admin/applications', {
        withCredentials: true,
        params: {
  ...
  const handleDeleteApplication = async (applicationId) => {
    try {
      await axios.delete(`/api/admin/applications/${applicationId}`, {
        withCredentials: true
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
      ...
      {deleteConfirm.show && (
        <div className="fixed inset-0 bg-black bg-opacity-75 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-black rounded-xl p-6 max-w-md w-full mx-4 border border-red-600">
