        ...
        <div className="flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-8">
          ...
          <div className="flex-1">
                  ...
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-white">{stats?.summary?.totalApplications || 0}</p>
                      </div>
                  ...
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-white">{stats?.summary?.approvedApplications || 0}</p>
                      </div>
                  ...
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-white">{stats?.summary?.pendingApplications || 0}</p>
                      </div>
                  ...
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-white">₹{stats?.summary?.totalAmount?.toLocaleString() || 0}</p>
                      </div>
            ...
            {activeTab === 'applications' && (
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <h2 className="text-xl md:text-2xl font-bold text-white">My Applications</h2>
                </div>
                          ...
                          <tbody className="divide-y divide-slate-700">
                            {applications.length > 0 ? applications.map((app) => (
                              <tr key={app._id} className="hover:bg-slate-700/50">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                                  ₹{app.loanSpecificDetails?.loanAmountRequired?.toLocaleString() || 'N/A'}
                                </td>
                        ...
                        {applications.length > 0 ? (
                          <div className="p-4 space-y-4">
                            {applications.map((app) => (
                              <div key={app._id} className="bg-slate-700/50 rounded-lg p-4 space-y-3">
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                                  <div>
                                    <h3 className="text-white font-medium">{app.loanType}</h3>
                                    <p className="text-gray-400 text-sm">ID: {app.applicationId}</p>
                                  </div>
                                  <span className={`inline-flex items-center space-x-1 px-3 py-1 text-xs font-medium rounded-full w-fit ${getStatusColor(app.status)}`}>
                                    {getStatusIcon(app.status)}
                                    <span className="ml-1">{app.status.replace('_', ' ').toUpperCase()}</span>
                                  </span>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                  <div>
                                    ...
                                    <p className="text-white font-medium">₹{app.loanSpecificDetails?.loanAmountRequired?.toLocaleString() || 'N/A'}</p>
                                  </div>
                                  <div>
                                ...
                                <div className="flex items-center space-x-4 pt-2 border-t border-slate-600">
                                  ...
                                  <button className="flex items-center space-x-2 text-green-400 hover:text-green-300 text-sm">
                                    <FiDownload className="w-4 h-4" />
                                    <span>Download</span>
                                  </button>
                                </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        {editMode ? (
                          <input
                            ...
                            className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white focus:outline-none focus:border-blue-500 text-sm md:text-base"
                          />
                        ) : (
                          <p className="text-white text-sm md:text-base">{user?.name || 'Not specified'}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {editMode ? (
                          ...
                          <p className="text-white text-sm md:text-base">{user?.email || 'Not specified'}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        {editMode ? (
                          ...
                          <p className="text-white text-sm md:text-base">{user?.phoneNumber || 'Not specified'}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {editMode ? (
                          ...
                          <p className="text-white text-sm md:text-base">{user?.pincode || 'Not specified'}</p>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  {editMode && (
                    <div className="mt-6 flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4">
                      <button
                        ...
                        className="w-full sm:w-auto flex items-center justify-center space-x-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto flex items-center justify-center space-x-2 px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors"
                      >
            ...
            {activeTab === 'settings' && (
              <div className="space-y-6">
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-slate-700">
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-4">Account Preferences</h3>
                  <div className="space-y-6">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                      <div className="flex-1">
                  ...
                  <div className="mt-8 pt-6 border-t border-slate-700">
                    ...
                    <div className="space-y-4">
                      <button className="w-full sm:w-auto flex items-center justify-center space-x-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">
                        <FiSettings className="w-4 h-4" />
                        <span>Change Password</span>
                      </button>
                      <button className="w-full sm:w-auto flex items-center justify-center space-x-2 px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors">
                        <FiX className="w-4 h-4" />
