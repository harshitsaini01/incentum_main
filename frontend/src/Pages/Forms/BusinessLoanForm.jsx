...
import { FaUser, FaBriefcase, FaBuilding, FaFileAlt, FaUsers, FaCheck, FaArrowLeft, FaArrowRight } from 'react-icons/fa';
...
const BusinessLoanForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    gender: '',
    qualification: '',
    employmentType: 'Business', // Fixed for business loan
    maritalStatus: '',
    ...
    // Step 3: Business Employment Details (Business Only)
    firmName: '',
    firmType: '',
  ...
  const nextStep = async () => {
    ...
    switch (currentStep) {
      ...
      case 2:
        stepData = {
          propertyFinalised: formData.propertyFinalised,
          propertyAddress: formData.propertyAddress,
          agreementExecuted: formData.agreementExecuted,
  ...
  const renderPropertyAndLoanDetails = () => (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-white mb-2">Property & Loan Details</h2>
        <p className="text-gray-300">Please provide property and loan information</p>
      </div>
      ...
      <div className="bg-white/5 rounded-xl p-6 border border-white/10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex gap-6">
              <label className="flex items-center">
                <input
                  ...
                  value="true"
                  checked={formData.propertyFinalised === true}
                  onChange={() => handleInputChange({
                    target: { name: 'propertyFinalised', value: true, type: 'radio' }
                  })}
              ...
              <label className="flex items-center">
                <input
                  ...
                  name="propertyFinalised"
                  value="false"
                  checked={formData.propertyFinalised === false}
                  onChange={() => handleInputChange({
                    target: { name: 'propertyFinalised', value: false, type: 'radio' }
                  })}
                  className="mr-2 text-blue-500"
                />
            ...
            <div className="flex gap-6">
              <label className="flex items-center">
                <input
                  ...
                  value="true"
                  checked={formData.agreementExecuted === true}
                  onChange={() => handleInputChange({
                    target: { name: 'agreementExecuted', value: true, type: 'radio' }
                  })}
                  className="mr-2 text-blue-500"
                />
                <span className="text-white">Yes</span>
              ...
              <label className="flex items-center">
                <input
                  ...
                  name="agreementExecuted"
                  value="false"
                  checked={formData.agreementExecuted === false}
                  onChange={() => handleInputChange({
                    target: { name: 'agreementExecuted', value: false, type: 'radio' }
                  })}
                  className="mr-2 text-blue-500"
                />
                <span className="text-white">No</span>
          ...
          {formData.agreementExecuted && (
            <div>
              <label className="block text-sm font-medium text-gray-100 mb-2">
                Agreement/MoU Value (Rs.)
              </label>
              <input
                type="number"
                name="agreementValue"
  ...
  const renderBusinessEmploymentDetails = () => (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-white mb-2">Employment Details - Applicant 1</h2>
        <p className="text-gray-300">Please provide your business information</p>
      </div>
  ...
  const renderDocuments = () => {
    const businessDocs = [
      { key: 'panCardFirm', label: 'PAN Card of Firm' },
      { key: 'kycDirectors', label: 'KYC of Proprietor/Partners/Directors' },
      { key: 'firmRegistration', label: 'Firm Registration Certificate' },
      { key: 'incorporationCertificate', label: 'Certificate For Incorporation' },
      { key: 'articleAssociation', label: 'Article Of Association' },
      { key: 'memorandumAssociation', label: 'Memorandum Of Association' },
      { key: 'gstr', label: 'GSTR for Last Year' },
      { key: 'businessAccountStatement', label: 'Last 6 or 12 Month Business Account Statement' },
      ...
      { key: 'otherDocuments', label: 'Other Relevant Documents' }
    ];

    return (
      <div className="space-y-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-white mb-2">Document Upload - BUSINESS LOAN APPLICATION</h2>
          <p className="text-gray-300">Please upload the required business documents</p>
        </div>
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 2:
        return renderPropertyAndLoanDetails();
      case 3:
        return renderBusinessEmploymentDetails();
      case 4:
  ...
  const steps = [
    ...
    { number: 2, title: 'Property & Loan Details', icon: FaBuilding },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Complete your business loan application in simple steps. Our team will review and get back to you within 24 hours.
            </p>
          </div>
