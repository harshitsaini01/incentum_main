...
const ApplicationSummary = () => {
  ...
  const fetchApplicationData = async () => {
    try {
      const response = await fetch(`/multi-step-form/form/${formId}`, {
        credentials: 'include'
      });
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-blue-700 text-sm mb-2">Phone: +91 8290052977</p>
              <p className="text-blue-700 text-sm">Email: info@incentum.ai</p>
            </div>
            <div>
