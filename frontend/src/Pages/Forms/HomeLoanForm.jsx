...
const HomeLoanForm = () => {
  ...
  const handleNextFromStep1 = async () => {
    ...
    try {
      ...
      console.log('✅ Step 1 save response:', saveResponse.data);
  ...
  const handleNextFromStep2 = async () => {
    ...
    try {
      // Save step 2 data (loan details) - Step 1 data already saved in handleNextFromStep1
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Complete your home loan application in simple steps. Our team will review and get back to you within 24 hours.
            </p>
          </div>
