...
import { FaUser, FaBriefcase, FaCar, FaFileAlt, FaUsers, FaCheck, FaArrowLeft, FaArrowRight } from 'react-icons/fa';
...
const VehicleLoanForm = () => {
  ...
  const handleCoApplicantCancel = () => {
    ...
    try {
      // Save all step data before submitting
      ...
      // Save employment details (step 3)
      if (formData.employmentType === 'Salaried') {
      ...
      // Save documents (step 4)
      if (Object.keys(documents).length > 0) {
        await saveStepData(4, documents);
      }

      // Save co-applicants data (step 5)
      ...
      if (response.data.success) {
        toast.success('Vehicle loan application submitted successfully!');
  ...
  const renderVehicleDetails = () => (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-white mb-2">Vehicle Details</h2>
        <p className="text-gray-300">Please provide vehicle and loan information</p>
      </div>
  ...
  const renderDocuments = () => {
    const salariedDocs = [
      ...
      { key: 'drivingLicense', label: 'Driving License (Self or Family)' }
    ];
    ...
    return (
      <div className="space-y-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-white mb-2">Document Upload - VEHICLE LOAN APPLICATION</h2>
  ...
  const steps = [
    ...
    { number: 2, title: 'Vehicle Details', icon: FaCar },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Complete your vehicle loan application in simple steps. Our team will review and get back to you within 24 hours.
            </p>
          </div>
