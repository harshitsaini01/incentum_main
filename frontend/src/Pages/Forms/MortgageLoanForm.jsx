...
import { FaUser, FaBriefcase, FaHome, FaFileAlt, FaUsers, FaCheck, FaArrowLeft, FaArrowRight } from 'react-icons/fa';
import axios from 'axios';
import { toast } from 'react-toastify';
import CoApplicantManager from './steps/CoApplicantManager';
import CoApplicantFlow from './steps/CoApplicantFlow';

const MortgageLoanForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    // Step 2: Property & Loan Details (Same as Home Loan)
    ...
    try {
      ...
      if (!currentApplicationId) {
        ...
        if (createResponse.data.success) {
          currentApplicationId = createResponse.data.applicationId;
  ...
  const handleFinishApplication = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        toast.success('Mortgage loan application submitted successfully!');
  ...
  const renderDocuments = () => {
    ...
    return (
      <div className="space-y-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-white mb-2">Document Upload - MORTGAGE LOAN APPLICATION</h2>
  ...
  const steps = [
    ...
    { number: 2, title: 'Property & Loan Details', icon: FaHome },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Complete your mortgage loan application in simple steps. Our team will review and get back to you within 24 hours.
            </p>
          </div>
