...
const ContactUs = () => {
  ...
  const [activeOffice, setActiveOffice] = useState('pune');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              We have two convenient locations to serve you better - in Pune and Jaipur&apos;s prime business districts.
            </p>
          </div>
          ...
          <div className="flex justify-center mb-8">
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-2 border border-white/20">
              <div className="flex space-x-2">
                ...
                <button 
                  onClick={() => setActiveOffice('jaipur')}
                  className={`px-6 py-3 rounded-lg font-medium transition-all duration-300 ${
                    activeOffice === 'jaipur' 
                      ? 'bg-blue-500 text-white shadow-lg' 
                      : 'text-gray-300 hover:text-white hover:bg-white/10'
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-2xl font-bold text-white mb-6">
                  INCENTUM Financial Services - {activeOffice === 'pune' ? 'Pune' : 'Jaipur'}
                </h3>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        {activeOffice === 'pune' 
                          ? 'PC Soft Building, 3rd Floor, Bhandarkar Road, Pune - 411004'
                          : '28, shiv gorax nagar, modal town, jagatpura, malviya Nagar jaipur 302017'
                        }
                      </p>
                    </div>
                  </div>
                ...
                <div className="aspect-w-16 aspect-h-12 bg-gray-800 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-400 text-sm">
                      Visit us at our {activeOffice === 'pune' ? 'Pune' : 'Jaipur'} office
                    </p>
                    <button 
                      onClick={() => window.open(
                        activeOffice === 'pune' 
                          ? 'https://maps.app.goo.gl/b4SXiWM5McgbUtXn6'
                          : 'https://maps.app.goo.gl/JLvSUAHhd2g7Ux4C6'
                        , '_blank'
                      )}
