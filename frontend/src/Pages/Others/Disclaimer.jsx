      ...
      <div className="relative z-10">
        ...
        <section className="flex flex-col items-center text-center py-8 px-6">
          ...
          <p className="text-lg md:text-2xl mt-2 text-gray-300 max-w-4xl">
            Welcome to <span className="text-blue-400 font-semibold">incentum.ai</span>, your trusted partner in
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="relative" id="liability" ref={refs.liability}>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mt-4">
              In no event shall <span className="text-blue-400 font-semibold">incentum.ai</span>, its directors,
          ...
          <div className="relative" id="noAdvice" ref={refs.noAdvice}>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mt-4">
              ...
              <span className="text-blue-400 font-semibold">incentum.ai</span> is not responsible for any actions
          ...
          <div className="relative" id="thirdPartyLinks" ref={refs.thirdPartyLinks}>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mt-4">
              ...
              <span className="text-blue-400 font-semibold">incentum.ai</span>. We have no control over, and assume
              ...
              <span className="text-blue-400 font-semibold">incentum.ai</span> shall not be responsible or liable,
