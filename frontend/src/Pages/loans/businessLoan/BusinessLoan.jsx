...
export default function BusinessLoan() {
  ...
  const premiumFeatures = [
    ...
    },
    {
      ...
      description: "Up to 10 years repayment",
  ...
  const valuePropositions = [
    {
      ...
      description: "Our advanced system analyzes your business profile and matches you with the most suitable business loan products from our network of trusted banking partners.",
      features: ["Business Analysis", "Rate Comparison", "Customized Solutions"],
    ...
    },
    {
      ...
      description: "Access exclusive offers, cashback opportunities, and premium services that add significant value to your business loan experience.",
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center min-h-[70vh] md:min-h-[80vh]">
              ...
              <div className="space-y-6 md:space-y-8">
                <motion.div {...slideInLeft}>
                  ...
                  >
                    <span className="font-bold text-sm sm:text-base tracking-wide uppercase flex items-center gap-2 md:gap-3">
                      ...
                      <span className="text-white drop-shadow-sm">Business Loan Solutions</span>
                    </span>
                  </motion.div>
                </motion.div>
                ...
                >
                  At INCENTUM, we are dedicated to providing businesses with the financial resources they need to grow and thrive. Whether you are looking to expand your operations, invest in equipment, or manage working capital.
                </motion.p>
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-16 relative z-10">
          ...
          >
            ...
            >
              We provide comprehensive business loan solutions with professional service, 
